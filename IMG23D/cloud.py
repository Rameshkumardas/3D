...
def SaveOnCloudIMG23D(output_path="https://cloudinary-devs.github.io/cld-docs-assets/assets/images/butterfly.jpeg"):
 # Upload the image.
...
def SaveOnCloudTXT23D(output_path="https://cloudinary-devs.github.io/cld-docs-assets/assets/images/butterfly.jpeg", rembg_output_path="https://cloudinary-devs.github.io/cld-docs-assets/assets/images/butterfly.jpeg"):
 # Upload the image.
  # Set the asset's public ID and allow overwriting the asset with new versions
  result1 = cloudinary.uploader.upload(output_path, public_id=f"kliky/{output_path.split('/')[-1]}", unique_filename = False, overwrite=True)
  # Log the image URL to the console. 
